...
##        break
        ...
        try:    
            market = data[2].split("Market Price")[1].split("P")
            #print data[0]
            median = data[2].split("Listed Median")[1].split("\n")
            
        except:
            market=['$9999']
            median=['$9999']
            
        cleanPrices.append(market[0].strip()[1:])
        cleanPrices.append(median[0].strip()[1:])
##        print data[0]
##        print data[1]
##        print cleanPrices

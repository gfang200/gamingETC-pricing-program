...
The Challenge
--------------- 
As a physical first asset, the market data for these cards is considered a commodity. Companies that hold optimized pricing data data have a competitive advantage against those that don't. Due to this, several preventative measures have been employed by these companies to protect this data. <br/>
...
<br/><br/>
For screenshots, you can also check out the documentation in GamingETC Pricing Program Manual 2016!
